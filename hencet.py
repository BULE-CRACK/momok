...
def banner():
    ...
    {m}•{k}•{h}•{sir}__  __ ____    ____   _    ____  ___ _____
    |  \/  |  _ \  |  _ \ / \  |  _ \|_ _|__  /
    | |\/| | |_) | | |_) / _ \ | |_) || |  / /
    | |  | |  _ < _|  __/ ___ \|  _ < | | / /_
    |_|  |_|_| \_(_)_| /_/   \_\_| \_\___/____|{x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f'{x}>> 1. Akun #-----------------[ IMPORT-MODULE ]-------------------
import requests,bs4,json,os,sys,random,datetime,time,re
import urllib3,rich,base64
from rich.table import Table as me
from rich.console import Console as sol
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} SEDANG MENUNGGU MANTAN {m}•{k}•{h}•{x} <<<<< ')
	print('')
...
def crack(idf,pwv):
	...
	sys.stdout.flush()
	ua = 'Mozilla/5.0 (Linux; Android 9; RMX1941) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36'
	ua2 = 'Mozilla/5.0 (Linux; Android 9; RMX1941) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36'
	ses = requests.Session()
	for pw in pwv:
		try:
...
def crackfree(idf,pwv):
	...
	sys.stdout.flush()
	ua = 'Mozilla/5.0 (Linux; Android 8.1.0; CPH1803) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36'
